...
public class LrcView extends View implements ILrcView {
     ...
     **/
    private int mSeekLineTextSize = 31;
    /**
     * 拖动歌词时，展示当前高亮歌词的时间的字体大小最小值
     **/
    private int mMinSeekLineTextSize = 28;
    /**
     * 拖动歌词时，展示当前高亮歌词的时间的字体大小最大值
     **/
    private int mMaxSeekLineTextSize = 36;

    /**
     * 歌词字体大小默认值
     **/
    private int mLrcFontSize = 36;    // font size of lrc
    /**
     * 歌词字体大小最小值
     **/
    private int mMinLrcFontSize = 31;
    /**
     * 歌词字体大小最大值
     **/
    private int mMaxLrcFontSize =39;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mLrcRows == null || mLrcRows.size() == 0) {
            if (mLoadingLrcTip != null) {
                ...
                canvas.drawText(mLoadingLrcTip, width / 2, height / 6- mLrcFontSize, mPaint);
            }
            return;
        }
